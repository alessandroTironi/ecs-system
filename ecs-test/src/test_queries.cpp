...
protected:
    void SetUp() override
    {
		ecs::ArchetypesDatabase::AddEntity<Position>(0);
		ecs::ArchetypesDatabase::AddEntity<Position>(1);
		ecs::ArchetypesDatabase::AddEntity<Position, Velocity>(2);
		ecs::ArchetypesDatabase::AddEntity<Velocity>(3);
		ecs::ArchetypesDatabase::AddEntity<Position, Velocity, Rotation>(4);
    }
